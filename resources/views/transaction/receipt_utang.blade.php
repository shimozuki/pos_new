...
<body>
	...
	<div class="body">
		...
		<table class="w-100">
			...
			<tr>
				<td class="left text-danger">Sisa Utang</td>
				<td class="right text-danger">{{ number_format($transaction->kembali,2,',','.') }}</td>
			</tr>
		</table>
		<hr class="hr-dash">
	</div>
	<div class="footer">
        <p class="center">Mohon Untuk Membayar Tepat Waktu</p>
